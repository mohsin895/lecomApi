...
class SslCommerzPaymentController extends Controller
{
    ...
    public function paymentGateway($post_data)
    {
...
*/
    public function success(Request $request)
    {
        ...
        if(!empty($tranId)){
            ...
            $orderInfo->isOnlinePaid=1;

            $orderInfo->updated_at=Carbon::now();

            if($orderInfo->save()){

                $paymentInfo=PaymentInfo::where('orderId',$orderId) 
                                            ->orderBy('id','DESC')
                                                ->first();

                $paymentInfo->paymentId=$request->bank_tran_id;
